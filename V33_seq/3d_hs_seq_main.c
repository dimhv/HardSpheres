...
static int t_max = (int)1e4;

static int num_threads = 1;


int len_pf_target = 6;
double pf_target[] = {0.65, 0.66, 0.67, 0.68, 0.6835, 0.6883};
...
//seting pressure distribution//########################################################
    ...
    for(ii=0; ii< trlx; ++ii){
        ...
        g_r_dist_count(0, samples);
        printScrollingValue((double)ii, (double)trlx);

    }

    bac_double = g_r_dist_return(0, samples, (double)trlx);
